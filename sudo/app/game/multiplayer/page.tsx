...
export default function MultiplayerDifficultySelection() {
        ...
        <div className="max-w-5xl rounded-3xl border-4 border-orange-400/60 bg-linear-to-br from-orange-50/95 via-amber-50/95 to-orange-100/95 p-8 shadow-2xl backdrop-blur-sm sm:p-12 md:p-16">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-lg font-semibold tracking-wide text-orange-700">
              Choose difficulty to compete with friends
            </p>
          </div>

          {/* Difficulty Cards */}
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-8">
            {/* Easy Multiplayer - 4x4 */}
            <Link href="/game/multiplayer/play?difficulty=easy">
            ...
            {/* Medium Multiplayer - 6x6 */}
            <Link href="/game/multiplayer/play?difficulty=medium">
            ...
            {/* Hard Multiplayer - 9x9 */}
            <Link href="/game/multiplayer/play?difficulty=hard">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm font-medium text-orange-600">
              ⚔️ First to complete wins! Same puzzle for both players.
            </p>
          </div>
        </div>
